...
export interface WikidataMovieRecord {
  id: string; // e.g. Q4699313
  title: string;
  originalTitle: string;
  originalLanguage: string; // 'te' | 'hi'
  releaseDate: string;
  releaseYear: number;
  overview: string;
  runtime?: number;
  ...
  directors: Array<{ id?: number; name: string; profileUrl?: string }>;
  musicDirectors: Array<{ id?: number; name: string; profileUrl?: string }>;
  cast: Array<{
    id?: number;
    name: string;
    character?: string;
...
export const WIKIDATA_HISTORICAL_CATALOG: WikidataMovieRecord[] = [
  {
    ...
    "releaseYear": 2002,
    "overview": "An ad agency manager who harbors deep resentment towards women due to a bitter past heartbreak falls in love with his newly hired creative director in Paris.",
    "runtime": 140,
    "budget": 60000000,
    "revenue": 210000000,
    "rating": 8.4,
    "voteCount": 14000,
    "posterUrl": "https://image.tmdb.org/t/p/w500/manmadhudu_poster.jpg",
    "tmdbId": 200202,
    "imdbId": "tt0380531",
    "genres": [
      {
  ...
  },
  {
    ...
    "releaseYear": 2010,
    "overview": "The idealistic US-educated son of an assassinated Chief Minister assumes office and wages an all-out ethical war against rampant political corruption.",
    "runtime": 165,
    "budget": 120000000,
    "revenue": 350000000,
    "rating": 8,
    "voteCount": 11000,
    "posterUrl": "https://image.tmdb.org/t/p/w500/leader_poster.jpg",
    "tmdbId": 201010,
    "imdbId": "tt1585257",
    "genres": [
      {
  ...
  },
  {
    ...
    "directors": [
      {
        "name": "Amit V. Masurkar"
      }
    ],
    "musicDirectors": [
      {
        "name": "Naren Chandavarkar"
      }
    ],
    "cast": [
      {
  ...
  },
  {
    ...
    "originalTitle": "బ్రోచేవారెవరురా",
    "originalLanguage": "te",
    "releaseDate": "2019-06-28",
    "releaseYear": 2019,
    "overview": "Three underperforming intermediate students plan a fake kidnapping to help their classmate escape her strict father, setting off a hilarious chain of unintended mishaps.",
    "runtime": 138,
    "budget": 35000000,
    "revenue": 160000000,
    "rating": 8,
    "voteCount": 10200,
    "posterUrl": "https://image.tmdb.org/t/p/w500/brochevarevarura_poster.jpg",
    "tmdbId": 201912,
    "imdbId": "tt9700346",
    "genres": [
      {
